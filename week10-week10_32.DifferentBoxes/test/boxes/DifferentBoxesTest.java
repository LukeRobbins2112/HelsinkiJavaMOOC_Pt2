...
public class DifferentBoxesTest {
    ...
    @Test
    @Points("32.1")
    public void thingConstructorThrowsExceptionWhenNegativeWeight() throws Exception {
        try {
    ...
    @Test
    @Points("32.1")
    public void equalsMethodImplemented() throws Exception {
    ...
    @Test
    @Points("32.1")
    public void hashCodeMethodImplemented() throws Exception {
        Thing tavara = new Thing("Hesse", 5);
